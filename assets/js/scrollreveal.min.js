    ...
    return e.prototype = {
        ...
        _scrollPage: function() {
            ...
            this.elems.forEach(function(e, i) {
                t.update(e)
                // console.log('t.update(e)', t.update(e))
            }), this.scrolled = !1
        },
        parseLanguage: function(t) {
            ...
            var i = t.getAttribute("data-scroll-reveal")
                .split(/[, ]+/),
                o = {};
        ...
        isElementInViewport: function(e, i) {
            var o = t.pageYOffset,
                ...
                a = s + n,
                i = i || 0;
            return r >= s + n * i && a >= o || "fixed" == (e.currentStyle ? e.currentStyle : t.getComputedStyle(e, null))
                .position
        },
        extend: function(t, e) {
